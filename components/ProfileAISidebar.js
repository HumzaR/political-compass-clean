// components/ProfileAISidebar.js
"use client";
...
export default function ProfileAISidebar() {
    ...
    <aside className="w-64 shrink-0 border-r border-neutral-200 dark:border-neutral-800 bg-white/70 dark:bg-neutral-950/70 backdrop-blur min-h-screen flex flex-col">
      ...
      <nav className="px-2 pb-4 space-y-1">
        {NAV.map(({ href, label, Icon }) => {
          ...
          const activeCls =
            "bg-neutral-900 text-white dark:bg-neutral-200 dark:text-neutral-900"; // keeps your black active look
          return (
