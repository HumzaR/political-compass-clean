...
function ProfileInner() {
  ...
  // Followers modal loaders (unchanged)
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="flex gap-2 mt-6 mb-6">
        <button onClick={() => setActiveTab("overview")} className={["px-4 py-2 rounded", activeTab === "overview" ? "bg-indigo-600 text-white" : "bg-gray-200 text-gray-800"].join(" ")}>
          Overview
        </button>
      ...
      {activeTab === "overview" ? (
        <div className="bg-white p-6 rounded shadow">
          ...
          {!hasResult && <p className="mt-3 text-center text-gray-600">No quiz result yet. Please take the quiz.</p>}
          {hasResult && (
        ...
        <div className="bg-white p-6 rounded shadow">
          ...
          {/* Hot Topics list remains as you had it */}
          {loadingAnswers ? (
            <p>Loading answers…</p>
      ...
      {/* Followers / Following modals unchanged */}
      {/* ... keep your existing Modal usages and list renderers here ... */}
    </div>
  );
}
