    ...
    <>
      ...
      <div className="max-w-3xl">
        ...
        <p className="text-sm text-gray-600 mb-6">
          A quick snapshot of where you sit on key axes. Numbers are normalized
          to a −100..+100 scale.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="rounded-xl border border-gray-200 p-5">
            ...
            <AxisBar
              label="Economic (Market vs Equality)"
              value={scores.economic}
            />
            <AxisBar
              label="Social (Libertarian vs Authoritarian)"
              value={scores.social}
            />
          </div>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 p-5 mb-8">
          ...
          {!drivers.length ? (
            <div className="text-gray-600 text-sm">
              We’ll highlight the answers with the largest influence once you
        ...
        <details className="rounded-xl border border-gray-200 p-5">
          ...
          <pre className="mt-3 text-[12px] overflow-x-auto">
            {JSON.stringify(
              {
                scores,
                answersSample: Object.fromEntries(
                  Object.entries(answers || {}).slice(0, 10)
                ),
              },
              null,
              2
